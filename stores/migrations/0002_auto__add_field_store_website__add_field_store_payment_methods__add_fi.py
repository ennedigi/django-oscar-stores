...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Store.website'
        db.add_column(u'stores_store', 'website',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Store.payment_methods'
        db.add_column(u'stores_store', 'payment_methods',
                      self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Store.disabled_friendly'
        db.add_column(u'stores_store', 'disabled_friendly',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Store.baby_friendly'
        db.add_column(u'stores_store', 'baby_friendly',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Store.website'
        db.delete_column(u'stores_store', 'website')

        # Deleting field 'Store.payment_methods'
        db.delete_column(u'stores_store', 'payment_methods')

        # Deleting field 'Store.disabled_friendly'
        db.delete_column(u'stores_store', 'disabled_friendly')

        # Deleting field 'Store.baby_friendly'
        db.delete_column(u'stores_store', 'baby_friendly')
    ...
    models = {
        ...
        u'stores.store': {
            ...
            'baby_friendly': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '2000', 'null': 'True', 'blank': 'True'}),
            'disabled_friendly': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'payment_methods': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
        ...
        u'stores.storestock': {
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'store_stock'", 'to': u"orm['catalogue.Product']"}),
