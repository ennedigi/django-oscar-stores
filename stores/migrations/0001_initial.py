...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'stores_storeaddress', (
        ...
        db.send_create_signal(u'stores', ['StoreAddress'])

        # Adding model 'StoreGroup'
        db.create_table(u'stores_storegroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=100)),
        ))
        db.send_create_signal(u'stores', ['StoreGroup'])
        ...
        db.create_table(u'stores_store', (
            ...
            ('location', self.gf('djgeojson.fields.PointField')()),
        ...
        db.create_table(u'stores_openingperiod', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'stores', ['OpeningPeriod'])

        # Adding model 'StoreStock'
        db.create_table(u'stores_storestock', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'stores', ['StoreStock'])

        # Adding unique constraint on 'StoreStock', fields ['store', 'product']
        db.create_unique(u'stores_storestock', ['store_id', 'product_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'StoreStock', fields ['store', 'product']
        db.delete_unique(u'stores_storestock', ['store_id', 'product_id'])

        # Deleting model 'StoreAddress'
        db.delete_table(u'stores_storeaddress')

        # Deleting model 'StoreGroup'
        db.delete_table(u'stores_storegroup')

        # Deleting model 'Store'
        db.delete_table(u'stores_store')

        # Deleting model 'OpeningPeriod'
        db.delete_table(u'stores_openingperiod')

        # Deleting model 'StoreStock'
        db.delete_table(u'stores_storestock')
